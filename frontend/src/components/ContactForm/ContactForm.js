	    ...
	    <div>
		{
			...
			render={({
				...
				<div className='center'>
				    <Row>
					<Col offset='s1 m2' s={10} m={8}>
					    <h4>Kontaktformulär</h4>
					    <Divider/>
					    <Section>
						<h5>Kontaktuppgifter</h5>
						<Input s={12} m={12} name='name' 
						...
						<Input s={12} m={12} name="telephone"
					...
					<Col offset='s1 m2' s={10} m={8}>
					    <DataAgreement/>
					    <Row/>
					    <Input s={12} m={12} name='agreeTerms'
						     className='filled-in'
					    ...
					    />
					    <Col s={12} m={12}><ErrorInput touched={touched.agreeTerms} error={errors.agreeTerms}/></Col>
					</Col>
				    </Row>
				    <Row>
					<Col offset='m2' s={12} m={8}>
